...
BEGIN_MESSAGE_MAP(CTCPSAsyncApp, CWinApp)
...
// 唯一一個 CTCPSAsyncApp 物件

CTCPSAsyncApp theApp;


// CTCPSAsyncApp 初始化

BOOL CTCPSAsyncApp::InitInstance()
{
